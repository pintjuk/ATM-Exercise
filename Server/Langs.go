...
func MakeDefoultLangs() (l map[string]protocol.Lang) {
	...
	l["sv"][BALANCE] = "Din saldo: %f\n\t" + FgRed + "1" + Reset + ". Utag\n\t" + FgRed + "2" + Reset + ". Insetning"
	l["sv"][SUCLOGIN] = FgGreen + "Inlogning lukades!" + Reset + " Välkomen %s"

	l["en"] = protocol.Lang{ADD: "Welcome by stuff", HEJ: "welcome", INIT: "1) to login\n2) to change language", LANG: "1 en\n2 sv\n3 ch", ENTACC: "Enter account number:", ENTCODE: "Enter code:", ERR_ENTACC: FgRed + "Accountdosent Exist!" + Reset, ERR_CODE: FgRed + "Wrong code attempt %u/3!" + Reset}
	l["en"][SUCLOGIN] = FgGreen + "Sucsusful login!" + Reset + " Welcome %s"
	l["en"][BALANCE] = "Your balance is %f\n\t" + FgRed + "1" + Reset + ". Withdraw\n\t" + FgRed + "2" + Reset + ". Deposit"
	l["en"][AMOUNT] = "Enter amount!"
	l["en"][WITHDRAWL] = FgGreen + "Withdral Sucsesful!" + Reset
	l["en"][DIPOSIT] = FgGreen + "Diposit Sucsesful!" + Reset
